...
import { TradeRecord } from '../model/index';
import { getUserTradeRecords } from '../api/index';
...
export default function TradeRecordSection({ userId }: TradeRecordSectionProps) {
  ...
  const [activeTab, setActiveTab] = useState<'buy' | 'sell'>('buy'); // 현재 활성 탭
  ...
  return (
    <div>
      ...
      ) : tradeRecords.length === 0 && !isLoading ? (
        ...
        <div className="p-3">
          ...
          {isLoading ? (
            ...
            <div 
              ...
              className="overflow-y-auto scrollbar-hide max-h-[450px] rounded-lg" 
            >
              {activeTab === 'buy' && (
                <div className="pb-2">
